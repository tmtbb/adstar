...
public class PraiseListView extends AppCompatTextView {
    ...
    private List<CircleFriendBean.CircleListBean.ApproveListBean> datas;
    ...
    public List<CircleFriendBean.CircleListBean.ApproveListBean> getDatas() {
        return datas;
    }
    public void setDatas(List<CircleFriendBean.CircleListBean.ApproveListBean> datas) {
        this.datas = datas;
    ...
    public void notifyDataSetChanged(){
        ...
        if(datas != null && datas.size() > 0){
            ...
            CircleFriendBean.CircleListBean.ApproveListBean item = null;
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(AppApplication.getAppContext(), R.drawable.praise_down, DynamicDrawableSpan.ALIGN_BASELINE),
