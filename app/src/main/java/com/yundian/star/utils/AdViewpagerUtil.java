...
public class AdViewpagerUtil {
    ...
    private int delayTime = 20000; //自动轮播的时间间隔
    ...
    private int dotoffset = 8; //小圆点的间距
        ...
        if (urls.length > 0) {
            ...
            for (int i = 0; i < length; i++) {
                if (i < length - 2) {
                    ...
                    ImageLoaderUtils.displayWithDefaultImg(context, mImageViews[i + 1], url,R.drawable.rec_bg);
            ...
            ImageLoaderUtils.displayWithDefaultImg(context, mImageViews[0], urls[urls.length - 1],R.drawable.rec_bg);
            ImageLoaderUtils.displayWithDefaultImg(context, mImageViews[length - 1], urls[0],R.drawable.rec_bg);
        }
    }
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (onAdPageChangeListener != null) {
                    onAdPageChangeListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
                }
            }
            ...
            public void onPageSelected(int position) {
                ...
                if (lastPosition > position && lastPosition != imgsize - 1) {
                    isRight = false;
                ...
                if (onAdPageChangeListener != null) {
                    onAdPageChangeListener.onPageSelected(position);
                }
            }
            ...
            public void onPageScrollStateChanged(int state) {
                ...
                if (onAdPageChangeListener != null) {
                    onAdPageChangeListener.onPageScrollStateChanged(state);
                }
            }
        });
    ...
    public void initDots(int length) {
        ...
        LinearLayout.LayoutParams mParams = new LinearLayout.LayoutParams(DisplayUtil.dip2px(dotsize), DisplayUtil.dip2px(dotsize));
        mParams.setMargins(DisplayUtil.dip2px(dotoffset), 0, DisplayUtil.dip2px(dotoffset), 0);//设置小圆点左右之间的间隔
