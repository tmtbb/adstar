...
public class DatasUtil {
	...
	public static List<CircleFriendBean.CircleListBean> createCircleDatas() {
		List<CircleFriendBean.CircleListBean> circleDatas = new ArrayList<CircleFriendBean.CircleListBean>();
		/*for (int i = 0; i < 15; i++) {
...
//	public static List<FavortTimeBean> createFavortItemList() {
//		int size = getRandomNum(users.size());
//		List<FavortTimeBean> items = new ArrayList<FavortTimeBean>();
//		List<String> history = new ArrayList<String>();
//		if (size > 0) {
//			for (int i = 0; i < size; i++) {
//				FavortTimeBean newItem = createFavortItem();
...
//	}
//
	public static CircleFriendBean.CircleListBean.ApproveListBean createFavortItem(int uid,String userName) {
		CircleFriendBean.CircleListBean.ApproveListBean item = new CircleFriendBean.CircleListBean.ApproveListBean();
		item.setUid(uid);
