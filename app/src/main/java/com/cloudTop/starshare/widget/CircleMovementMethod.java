...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppApplication.getAppContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppApplication.getAppContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
